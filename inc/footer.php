...
<div class="clearfix"></div>
 ...
 <!-- footer content -->
        <footer>
          <div class="pull-right" style="color: blue">
           <strong> </strong>
          </div>
          <div class="clearfix"></div>
        </footer>
...
<!-- Dropzone.js -->
    ...
    <!-- Custom Theme Scripts -->
        ...
        <script src="<?php echo $dcon->base_url ;?>/vendors/PACE/pace.min.js"></script>

<script src="<?php echo $dcon->base_url ;?>/vendor/diex.js"></script>
<script src="<?php echo $dcon->base_url ;?>/vendor/loader.js"></script>
